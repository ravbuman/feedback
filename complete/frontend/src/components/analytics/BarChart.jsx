...
const BarChart = ({ data, title }) => {
  ...
  const margin = { top: 20, right: 20, bottom: 60, left: 40 }; // Increased bottom margin for labels
          ...
          <g transform={`translate(${margin.left},${margin.top})`}>
            ...
            {data.map((d, i) => {
              ...
              return (
                <g key={i}>
                  <rect
                    x={x + barWidth * 0.1} // Add some padding between bars
                    y={y}
                    width={barWidth * 0.8} // Adjust width for padding
                    height={barHeight}
                    fill={color}
                  />
                  ...
                  <text
                    ...
                    fontSize="12"
                    fill="#555"
                    transform={`rotate(-45, ${x + barWidth / 2}, ${innerHeight + 10})`}
                  >
                    {d.label}
                  </text>
                </g>
